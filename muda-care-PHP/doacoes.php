...
<body>
  ...
  <h1>Doações e Recebimentos</h1>
  <button class="btn" onclick="abrirModal()">+ Registrar</button>
</div>
  ...
  <table>
    <thead>
      <tr>
        ...
        <th class="hide-mobile">Detalhes</th>
      </tr>
    </thead>
    <tbody>
      <!-- foreach movimentação tipo doacao/recebimento -->
      <tr>
        <td><!-- data --></td>
        <td><!-- nome muda --></td>
        <td><span class="badge badge-yellow">Doação</span></td> <!-- ou badge-green Recebimento -->
        <td class="text-right"><!-- qtd --></td>
        <td class="hide-mobile text-muted"><!-- descrição --></td>
      </tr>
      <!-- endforeach -->
    </tbody>
  </table>
  ...
  <div class="modal">
    ...
    <form method="POST" action="doacoes.php">
      ...
      <div class="form-group">
        <label>Tipo</label>
        <select name="tipo">
          <option value="doacao">Doação (saída)</option>
      ...
      <div class="form-group">
        <label>Destinatário / Origem</label>
