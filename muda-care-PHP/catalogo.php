...
<body>
  ...
  <h1>Catálogo de Mudas</h1>
  <button class="btn" onclick="abrirModal()">+ Nova Muda</button>
</div>
...
<div class="grid-cards">
  ...
  <div class="card">
    <div class="flex-between">
      <div>
        <h3 style="font-size:18px; font-weight:600;"><!-- nome --></h3>
        <span class="badge badge-green"><!-- tipo: Frutífera|Ornamental|Nativa|Medicinal|Exótica|Outra --></span>
      </div>
      <div>
        <a href="catalogo.php?editar=ID" title="Editar">✏️</a>
        <a href="catalogo.php?excluir=ID" title="Excluir" onclick="return confirm('Deseja excluir?')">🗑️</a>
      </div>
    </div>
    <div class="stat-value" style="color:#2d8a56; margin-top:8px;"><!-- quantidade --></div>
    <div class="text-muted">em estoque</div>
    <p class="text-muted" style="margin-top:8px;"><!-- descrição (opcional) --></p>
  </div>
  <!-- endforeach -->
</div>
