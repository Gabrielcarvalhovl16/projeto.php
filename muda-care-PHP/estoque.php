...
<body>
  ...
  <button class="btn" onclick="abrirModal()">+ Movimentação</button>
</div>
...
<div class="card">
  <table>
    ...
    <tbody>
      <!-- foreach movimentação tipo entrada/saida -->
      <tr>
        <td><!-- data --></td>
        <td><!-- nome muda --></td>
        <td><span class="badge badge-green">Entrada</span></td> <!-- ou badge-red Saída -->
    ...
    <form method="POST" action="estoque.php">
      <div class="form-group">
        ...
        <select name="muda_id" required>
          ...
          <!-- foreach muda --><option value="ID">Nome (qtd)</option><!-- endforeach -->
        </select>
      </div>
      <div class="form-group">
        <label>Tipo</label>
